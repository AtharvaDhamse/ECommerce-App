...
function App() {
  ...
  return (
    <div>
        ...
        {/* whatever value will be coming from setShowCart will be passed here */}
        {
          showCart ? 
          <CartList cart={cart}></CartList> :
          <ProductList product={product} addToCart={addToCart}></ProductList> // sending product as a prop
        }                 
        <Register/>
        <Login/>
    </div>
